...
The possible `hookName` values and the parameters passed to the hook function you return are documented over in the [Configuration](../../start-here/configuration.md) section of the docs.
