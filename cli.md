...
At a high level the CLI module is just a proxy to the raw [API](https://js.electronforge.io/classes/\_electron\_forge\_core.ForgeAPI.html) commands. Almost all the configuration is still done in your [Forge configuration](configuration.md), the CLI just provides a handy way to trigger all the core functionality of Electron Forge.
...
| Flag             | Value                               | Required | Description                                                                                                                                                                                                                  |
| ---------------- | ----------------------------------- | -------- | -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `--arch`         | Architecture, e.g. `x64`            | No       | Target architecture to make for. Defaults to the arch that you're running on (the "host" arch). Allowed values are: "ia32", "x64", "armv7l", "arm64", "universal", or "mips64el". Multiple values should be comma-separated. |                                                                                                                         |
