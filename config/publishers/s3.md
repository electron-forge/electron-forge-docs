...
First, you must configure the [s3.md](s3.md "mention") publisher to publish your files into an auto-updater compatible layout and use the [zip.md](../makers/zip.md "mention") maker (macOS) and the [squirrel.windows.md](../makers/squirrel.windows.md "mention") maker (Windows) to build your application.
