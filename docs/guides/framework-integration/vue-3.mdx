...
<Tabs
  ...
  values={[
    {label: 'src/index.html', value: 'src/index.html'},
    {label: 'src/App.vue', value: 'src/App.vue'},
    {label: 'src/renderer.js', value: 'src/renderer.js'},
    {label: 'vite.renderer.config.mjs', value: 'vite.renderer.config.mjs'},
  ]}>
<TabItem value="src/index.html">
...
<TabItem value="vite.renderer.config.mjs">
