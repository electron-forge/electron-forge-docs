...
[Bitbucket Cloud](https://bitbucket.org) only and will not work with self hosted
...
To use `@electron-forge/publisher-bitbucket`, add it to the `publishers` array
...
[`PublisherBitbucketConfig`](https://js.electronforge.io/interfaces/_electron_forge_publisher_bitbucket.PublisherBitbucketConfig.html).

> **Info:** Your artifacts can be found under the `Downloads` tab of
