...
<Tabs
  defaultValue="Main Process"
  values={[
    {label: 'Main Process', value: 'Main Process'},
    {label: 'Preload Script', value: 'Preload Script'},
    {label: 'Renderer Process', value: 'Renderer Process'},
  ]}>
<TabItem value="Main Process">
...
<TabItem value="Preload Script">

```jsx title="preload.js"
...
<TabItem value="Renderer Process">

```jsx title="renderer.js"
...
```tsx title="main.js (Main Process)"
...
```jsx title="Plugin configuration"
{
  name: '@electron-forge/plugin-webpack',
  config: {
...
```jsx title="webpack.main.config.js"
module.exports = {
  module: {
    rules: [
      {
...
```jsx title="main.js (Main Process)"
